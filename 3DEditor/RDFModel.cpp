...
// ************************************************************************************************
// Labels
static const char* TOP_LABEL = "";
...
void CSceneRDFModel::LoadLabels()
{
	...
	// Top
	{
		OwlInstance iLabelInstance = ImportModelA(m_iModel, (const unsigned char*)TOP_LABEL);
		...
		// Scale
		{
			...
			SetObjectProperty(iTransformationInstance, GetPropertyByName(GetModel(), "object"), &iLabelInstance, 1);

			// Translate
			{
				iMatrixInstance = CreateInstance(iMatrixClass, "Top Translate");
				ASSERT(iMatrixInstance != 0);
				...
				// Transformation
				int64_t iTransformationInstance2 = CreateInstance(iTransformationClass, "Top Translate");
				ASSERT(iTransformationInstance2 != 0);

				SetObjectProperty(iTransformationInstance2, GetPropertyByName(GetModel(), "matrix"), &iMatrixInstance, 1);
				SetObjectProperty(iTransformationInstance2, GetPropertyByName(GetModel(), "object"), &iTransformationInstance, 1);
			}
		}		
	}
	...
	// Bottom
	{
		...
		// Scale
		{
			...
			// Translate
			{
				iMatrixInstance = CreateInstance(iMatrixClass, "Bottom Translate");
				ASSERT(iMatrixInstance != 0);
				...
				// Transformation
				int64_t iTransformationInstance2 = CreateInstance(iTransformationClass, "Bottom Translate");
				ASSERT(iTransformationInstance2 != 0);
