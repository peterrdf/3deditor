...
namespace _dxf
{
	...
	public: // Methods
		...
		// ----------------------------------------------------------------------------------------
		string getMapping(const string& strCode);
	...
	public: // Methods
		...
		// ----------------------------------------------------------------------------------------
		const vector<_entry*>& entries() const;
	};
	// _table
	// --------------------------------------------------------------------------------------------
	...
	public: // Methods
		...
		// ----------------------------------------------------------------------------------------
		const vector<_table*>& tables() const;
	};
	// _tables_section
	// --------------------------------------------------------------------------------------------	
	...
	public: // Methods
		...
		// ----------------------------------------------------------------------------------------
		const vector<_block*>& blocks() const;
	...
	public: // Methods
		...
		// ----------------------------------------------------------------------------------------
		_layer* findLayerByName(const string& strLayerName);

		// ----------------------------------------------------------------------------------------
		bool isEntityOn(_entity* pEntity);
