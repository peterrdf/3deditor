...
// ------------------------------------------------------------------------------------------------
void CMainFrame::GenerateTests(const CString& strInputDataDir, const CString& strWildcard)
{
	...
	CTestManager testManager(GetController(), strInputDataDir); // folderPickerDialog.GetPathName());
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	lstBasicCommands.AddTail(ID_EXPORT_AS_CITYGML);
	...
	lstBasicCommands.AddTail(ID_FILE_SAVE_SCREENSHOT);
	...
	lstBasicCommands.AddTail(ID_SHOW_FACES_WIREFRAMES);
