...
class DragFace
    ...
    public:
        ...
        bool StartDrag (OwlInstance inst, int iConceptualFace, VECTOR3 const& startPoint, VECTOR3 const& eyeVector, Method method, RDFGEOM_CALLBACK_LOG logger, void* hostData, bool dynamicCursor);
