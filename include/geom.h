...
namespace GEOM
{
    ...
    public:
        ...
        static int64_t Create(int64_t model, const char* className, const wchar_t* instanseName)
        {
            int64_t clsid = GetClassByName(model, className);
            assert(clsid != 0);

            int64_t instance = CreateInstanceW(clsid, instanseName);
            assert(instance != 0);
        ...
        /// Create an instance of specified class
        /// </summary>
        static int64_t Create(int64_t model, const char* className) { return Create(model, className, (const char*) NULL); }
        ...
        {
            UNREFERENCED_PARAMETER(checkCardinality);
        ...
        template<typename TElem> void SetDatatypeProperty(const char* name, TElem* values, int64_t count)
        {
            ...
            int64_t res =
#endif // _DEBUG
                ::SetDatatypeProperty(m_instance, propId, values, count);
            assert(res == 0);
        }
        ...
        template<typename TElem> const TElem*  GetDatatypeProperty(const char* name, int64_t* pCount)
        {
            ...
            int64_t res = 
#endif // _DEBUG
                ::GetDatatypeProperty(m_instance, propId, (void**)&values, &count);
            assert(res == 0);
        ...
        template<class TInstance> void SetObjectProperty(const char* name, const TInstance* instances, int64_t count)
        {
            ...
            int64_t res = 
#endif // _DEBUG
                ::SetObjectProperty(m_instance, propId, (int64_t*)instances, count);
            assert(res == 0);
        }
        ...
        template<class TInstance> const TInstance* GetObjectProperty(const char* name, int64_t* pCount)
        {
            ...
            int64_t res =
#endif // _DEBUG
                ::GetObjectProperty(m_instance, propId, &values, &count);
            assert(res == 0);
    ...
    public:
        ...
        static Collection Create(int64_t model, const wchar_t* name) { return Collection(Instance::Create(model, "Collection", name), "Collection"); }
    ...
    public:
       ...
       //
       // Properties with known cardinality restrictions to Intersection
       //
