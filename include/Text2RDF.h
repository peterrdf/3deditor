...
public: // Methods
	...
	// --------------------------------------------------------------------------------------------
	// ctor
	CText2RDF(const CString & strText, const CString & strTTFFile, int64_t iModel, int iGeometry);

	// --------------------------------------------------------------------------------------------
	// ctor
	CText2RDF(const CString & strTTFFile, int64_t iModel, int iGeometry);
	...
	// --------------------------------------------------------------------------------------------
	// Getter
	const vector<int64_t> & GetLetters() const;

protected: // Methods

	// --------------------------------------------------------------------------------------------
	// Override to add extra content
	virtual void OnTextGenerationCompleted(double dTextWidth, double dTextHeight);
